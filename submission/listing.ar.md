...
الـCandidate الأول من نوع skills-only ولا يحتوي على MCP tools أو ربط حساب خارجي أو Telemetry أو خدمة يديرها المشروع. قد يختلف شكل الملف بين إصدارات Word والخطوط ونظام التشغيل والـrenderer وبرامج Office. ولا يُذكر Word Desktop verified إلا عند فتح نفس الملف وفحصه هناك.
